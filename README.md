...
| [Custom_Seasonal_Modeling_Node.zip](Custom%20modeling%20nodes/Seasonal_Model/Custom_Seasonal_Modeling_Node.zip)  | Viya 4  | Custom Seasonal Modeling Node with support for node-level Event Definitions and Event Usage mappings. See the [Custom Seasonal Modeling Node README](Custom%20modeling%20nodes/Seasonal_Model/README.md) and the [EVENTBY Documentation](https://go.documentation.sas.com/doc/en/pgmsascdc/v_075/hpfug/hpfug_hpfdiag_details33.htm#hpfug.hpfdiag.diagdetaileventby). |
